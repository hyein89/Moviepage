    ...
    <div id="container">
      <div className="module">
        <div className="content right full">
          <h1 className="Featured">Top Rated</h1>
            ...
            <ul className="pagination">
              {page > 1 && (
                <li className="previous">
                  <a href={`/top-rated?page=${prevPage}`}>{'<'}</a>
                </li>
              )}
              ...
              {Array.from({ length: 5 }).map((_, i) => {
                ...
                return (
                  <li key={p} className={p === page ? 'active' : ''}>
                    <a href={`/top-rated?page=${p}`}>{p}</a>
                  </li>
                )
              })}

              <li className="next">
                <a href={`/top-rated?page=${nextPage}`}>{'>'}</a>
              </li>
            </ul>
          </div>
        </div>
